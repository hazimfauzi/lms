    ...
    <ul class="nav nav-tabs nav-stacked ">
		...
		<div class="alert alert-danger">PROFILE</strong></div>
           ...
           <?php 
             ...
             <?php echo $row['level']; ?>
             <strong><br /></strong>
              <p><a href="student_edit.php" class="btn btn-success"><i class="icon-edit icon-large"></i>&nbsp;Edit</a> 
              <a href="studentchange_password.php" class="btn btn-success">&nbsp;Change Password</a></p>
