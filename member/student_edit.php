...
<?php $get_id = $session_id; ?>
    <div class="container">
		...
		?>
			...
			<p><a class="btn btn-info" href="student_dashboard.php"><i class="icon-arrow-left icon-large"></i>&nbsp;Back</a></p>
	<div class="addstudent">
	<div class="details">Please Enter Details Below</div>	
	<form class="form-horizontal" method="POST" action="student_update.php" enctype="multipart/form-data">
